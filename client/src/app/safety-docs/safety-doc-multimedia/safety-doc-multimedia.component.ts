...
@Component({
  selector: 'app-safety-doc-multimedia',
  templateUrl: './safety-doc-multimedia.component.html',
  styleUrls: ['./safety-doc-multimedia.component.css']
})
export class SafetyDocMultimediaComponent implements OnInit {
  title = 'frontend';
  selectedFiles = [];

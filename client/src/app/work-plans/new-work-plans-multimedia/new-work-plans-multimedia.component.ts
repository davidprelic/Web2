...
@Component({
  selector: 'app-new-work-plans-multimedia',
  templateUrl: './new-work-plans-multimedia.component.html',
  styleUrls: ['./new-work-plans-multimedia.component.css']
})
export class NewWorkPlansMultimediaComponent implements OnInit {
  title = 'frontend';
  selectedFiles = [];
